...
$BOARDING 			= isset($_POST['boarding']) ? $_POST['boarding'] : "";
...
$MOTHER_OCCU 		= $_POST['mOccu'];
$BOARDING 			= isset($_POST['boarding']) ? $_POST['boarding'] : "";
$WITH_FAMILY 		= isset($_POST['withfamily']) ? $_POST['withfamily'] : "";
$GUARDIAN 			= isset($_POST['guardian']) ? $_POST['guardian'] : "";
$GUARDIAN_ADDRESS 	= isset($_POST['guardianAdd']) ? $_POST['guardianAdd'] : "";
$OTHER_PERSON_SUPPORT = isset($_POST['otherperson']) ? $_POST['otherperson'] : "";
$ADDRESS 			= isset($_POST['otherAddress']) ? $_POST['otherAddress'] : "";
