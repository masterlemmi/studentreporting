...
<div class="rows" style="margin-top: 90px; background-color: #c4e6fb;"> 
			           ...
			           <div class="container">
					    ...
					    <span id="printout">
					     ...
					     <form class="form-horizontal span4" action="controller.php?action=delsubj&studentId=<?php echo $_GET['studentId']; ?>&cid=<?php echo $_GET['cid']; ?>&sy=<?php echo $_GET['sy']; ?>" method="POST">					    
								<table  class="table table-striped " style="background-color: #962929; color: #f7c4c4" border="none" cellspacing="0" id="table">
